...
if (!function_exists('cmsmasters_fonts_list')) {
	function cmsmasters_fonts_list() {
		...
		if (isset($cmsmasters_option['whiskers' . '_google_web_fonts']) && is_array($cmsmasters_option['whiskers' . '_google_web_fonts'])) {
			$google_web_fonts_array = $cmsmasters_option['whiskers' . '_google_web_fonts'];
		...
		$fonts = array( 
			'' => esc_html__('None', 'whiskers'), 
			'local' => $local_fonts, 
			'web' => $google_web_fonts 
		);
		
		
		return apply_filters('whiskers_google_fonts_list_filter', $fonts);
	}
}
...
if (!function_exists('cmsmasters_text_transform_list')) {
	function cmsmasters_text_transform_list() {
		$list = array( 
			...
			'uppercase' => esc_html__('uppercase', 'whiskers'), 
			'lowercase' => esc_html__('lowercase', 'whiskers'), 
			'capitalize' => esc_html__('capitalize', 'whiskers'), 
		);
...
if (!function_exists('cmsmasters_image_thumbnail_list')) {
	function cmsmasters_image_thumbnail_list() {
		$list = whiskers_get_image_thumbnail_list();
...
if (!function_exists('cmsmasters_color_schemes_list')) {
	function cmsmasters_color_schemes_list() {
		$list = whiskers_all_color_schemes_list();
