...
if (!function_exists('whiskers_get_custom_page_meta_fields')) {
function whiskers_get_custom_page_meta_fields() {
	$cmsmasters_option = whiskers_get_global_options();
	
	
	$cmsmasters_global_layout = (isset($cmsmasters_option['whiskers' . '_layout']) && $cmsmasters_option['whiskers' . '_layout'] !== '') ? $cmsmasters_option['whiskers' . '_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_header_overlaps = (isset($cmsmasters_option['whiskers' . '_header_overlaps']) && $cmsmasters_option['whiskers' . '_header_overlaps'] !== '') ? (($cmsmasters_option['whiskers' . '_header_overlaps'] == 1) ? 'true' : 'false') : 'false';
	...
	$custom_page_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Page Layout', 'whiskers'), 
			'desc'	=> '</br>' . esc_html__('Choosing layout with a sidebar please make sure to add widgets in the Appearance - Widgets tab. The empty sidebar won\'t be displayed.', 'whiskers'), 
			'id'	=> 'cmsmasters_layout', 
			'type'	=> 'radio_img', 
			'hide'	=> '', 
			...
			'options' => array( 
				'r_sidebar' => array( 
					...
					'label' => esc_html__('Right Sidebar', 'whiskers'), 
					'value'	=> 'r_sidebar' 
				), 
				'l_sidebar' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/sidebar_l.jpg', 
					'label' => esc_html__('Left Sidebar', 'whiskers'), 
					'value'	=> 'l_sidebar' 
				), 
				'fullwidth' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/fullwidth.jpg', 
					'label' => esc_html__('Full Width', 'whiskers'), 
					'value'	=> 'fullwidth' 
				) 
			) 
		), 
		array( 
			'label'	=> esc_html__('Header Overlaps Content', 'whiskers'), 
		...
		array( 
			'label'	=> esc_html__('Disabled Heading Block', 'whiskers'), 
			'desc'	=> esc_html__('Use this checkbox to disable heading block', 'whiskers'), 
		...
		array( 
			'label'	=> esc_html__('Choose Right\Left Sidebar', 'whiskers'), 
			'desc'	=> '', 
