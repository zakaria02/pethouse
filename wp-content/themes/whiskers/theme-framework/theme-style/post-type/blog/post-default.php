...
<article id="post-<?php the_ID(); ?>" <?php post_class('cmsmasters_post_default'); ?>>
	<div class="cmsmasters_post_cont">
		...
		if ($cmsmasters_post_format == 'image') {
			...
			whiskers_post_type_slider(get_the_ID(), $cmsmasters_post_images, 'post-thumbnail');
		} elseif ($cmsmasters_post_format == '' && !post_password_required() && has_post_thumbnail()) {
			whiskers_thumb(get_the_ID(), 'post-thumbnail', true, false, false, false, false, true, false);
		...
		<div class="cmsmasters_post_cont_inner">
			...
			if ($date || $likes || $comments) {
				echo '<footer class="cmsmasters_post_footer entry-meta">';
					...
					$date ? whiskers_get_post_date('page', 'default') : '';
